...
This will compile all the templates into one Lua module file which can be
loaded in your main OpenResty/Lua application as the module `myapp.templates`.
...
Now you have Lemplate support for these templates in your OpenResty
application.
...
The goal of Lemplate is to support all of the Template Toolkit features that
...
The remaining features will be added very soon. See the DESIGN document in the
distro for a list of all features and their progress.
